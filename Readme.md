# Projeto Criado para o Cliente Tottal Bahia Rastreadores.

O objetivo do sistema é ser um site que realize as funções de pesquisa na API da tabela Fipe, a fim de 
realizar uma lógica que traga um valor específico por veículo a partir das informações
fornecidas pelo cliente no momento da criação da cotação Online.

https://www.tottalbahiabr.com.br/

# Tecnologias utilizadas:

Javascript, jquery, PHP, HTML, Css, Bootstrap.
